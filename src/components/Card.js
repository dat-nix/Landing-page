...
const Card = ({ image, title, description }) => {
  return (
   <div className="flex flex-col md:flex-row w-full md:w-[80vw] h-auto md:h-[500px] bg-black overflow-hidden shadow-lg hover:scale-[1.02] transition-transform duration-300 md:p-0">
      {/* Left Image Section */}
