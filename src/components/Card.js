...
const Card = ({ image, title, description }) => {
  return (
   <div className="flex flex-col md:flex-row w-full md:w-[80vw] h-auto md:h-[500px] bg-black overflow-hidden shadow-lg hover:scale-[1.02] transition-transform duration-300 p-4 md:p-0">
      {/* Left Image Section */}
      ...
      {/* Right Text Section */}
      <div className="w-full md:w-[40%] flex flex-col justify-center p-8 md:p-10 bg-black text-white">
