...
<div className="requirements-container">
  ...
  <div className="requirement-card">
    ...
    <button className="register-button" disabled>Comming soon...</button>
  </div>
</div>
      {/* ▲▲▲ END OF NEW SECTION ▲▲▲ */}
      {/* ▼▼▼ Contact Us Section ▼▼▼ */}
  ...
  <div className="contact-icons">
    ...
    <img src="/facebookmono.png" alt="Facebook" className="contact-icon" /></a>
    <a href="https://www.instagram.com/rmitshinsei/" target="_blank" rel="noopener noreferrer">
    <img src="/instamono.png" alt="Instagram" className="contact-icon" /></a>
  </div>
</div>
