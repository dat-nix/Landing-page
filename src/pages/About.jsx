    ...
    return (
        <section id="about">
               ...
               <div className="flex flex-col lg:flex-row items-center max-w-full h-auto lg:h-screen">
                    ...
                    <div className="py-6 lg:py-10 flex flex-col lg:flex-row items-start w-full lg:w-3/4 px-6 lg:pl-12">
                        ...
                        <h1 className="text-orange-600 font-extrabold leading-tight uppercase">
                            <span className="block text-4xl lg:text-9xl">RMIT</span>
                            <span className="block text-4xl lg:text-9xl">SHINSEI</span>
                            <span className="block text-4xl lg:text-9xl">KENDO</span>
                            <span className="block text-4xl lg:text-9xl">CLUB</span>
                        </h1>
                    </div>
                    {/* Right Side: Club Description */}
                    <div className="w-full lg:w-1/2 px-6 py-6 lg:py-0">
                        ...
                        <p className="mt-4 text-lg lg:text-2xl text-black">
           ...
           <div className="w-full min-h-[150px] sm:min-h-[250px] md:min-h-[400px] mx-auto bg-white relative pt-4 sm:pt-1 mt-[-10px] sm:mt-[-20px]">
                ...
                {/* LATEST (Bottom-Right) */}
                <h2 className="absolute bottom-1 sm:bottom-4 right-4 sm:right-8 text-7xl sm:text-[60px] md:text-[190px] font-bold text-[#232323]">
                    {instructor.text}
                </h2>
            </div>
            ...
            <div className="w-full min-h-screen flex-shrink-0 bg-[#FFCA5A] py-10">
                <h2 
                     className="text-[#EB4F0B] text-center font-extrabold text-[48px] sm:text-[80px] md:text-[120px] lg:text-[150px] leading-[96%]" 
