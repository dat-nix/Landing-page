...
export const content = {
  en: {
    ...
    gallery: {
      ...
      sections: [
        {
          title: "Kendo Practice & Tutorial Class",
          images: [
            "kendo-practice-01.jpg",
            "kendo-practice-02.jpg",
            "kendo-practice-03.jpg",
            "kendo-practice-04.jpg",
            "kendo-practice-05.jpg",
            "kendo-practice-06.jpg",
          ],
        },
        {
          title: "Workshop & Cultural Events",
          images: [
            "event-01.jpg",
            "event-02.jpg",
            "event-03.jpg",
        ...
        {
          title: "ASEAN Kendo Training",
          images: [
            "asean-training-01.jpg",
            "asean-training-02.jpg",
            "asean-training-03.jpg",
            "asean-training-04.jpg",
            "asean-training-05.jpg",
            "asean-training-06.jpg",
          ],
        },
      ],
    },
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "A: Our membership fee is 550k per semester (3 months, including 1 month of semester break)",
      },
      {
        question:
          "Q: Do I have to bring my own equipment (shinai, bogu) to the dojo ?",
        answer:
          "A: We have spare shinais for everyone who doesn't have it. For anyone who can practice in bogu, you should bring your own bogu since we do not have enough spare bogu and storage to store bogu.",
      },
      {
        question: "Q: Do we have any requirements to join the club ?",
        answer:
          "A: To join our club, you must be a student or alumni of RMIT to access to our dojo. Besides, we welcome beginners who've never practiced Kendo and would like to try out, we also welcome anyone who used to train Kendo before to join us.",
      },
    ],
    ...
    footer: [
      ...
      {
        ownership: "This product fully belongs to RMIT Shinsei Kendo Club.",
      },

      {
        author: "Author",
        description: "RMIT Shinsei Tech Team",
      },
      {
        leader: "Project Leader",
        leaderName: "Pham Hoang Duong (Alex)",
      },
      {
        devs: "Developer",
        dev1: "Nguyen An",
    ...
    AgendaData: [
      {
        date: "May 30th",
        events: [
          { time: "6:30 PM", activity: "Seminar begins" },
  ...
  vn: {
    navbar: {
      home: "Trang chủ",
      about: "Giới thiệu",
      rikt: "Giải Đấu Kendo RMIT Ichigeki",
      contact: "Liên hệ",
      language: "English",
    ...
    gallery: {
      ...
      sections: [
        {
          title: "Luyện Tập Kendo & Hướng Dẫn",
          images: [
            "kendo-practice-01.jpg",
            "kendo-practice-02.jpg",
            "kendo-practice-03.jpg",
        ...
        {
          title: "Hội Thảo & Sự Kiện Văn Hóa",
          images: [
            "event-01.jpg",
            "event-02.jpg",
            "event-03.jpg",
    ...
    faqs: [
      {
        ...
        answer:
          "A: Đội tập chúng ta ở trong Nhà Thể Thao, Tòa Nhà 10 tại RMIT SGS",
      },
      {
        question: "Q: Học phí của câu lạc bộ là bao nhiêu ?",
        answer:
          "A: Học phí của chúng tôi là 550k mỗi học kỳ (3 tháng, bao gồm 1 tháng nghỉ giữa kỳ)",
      },
      {
        question:
          "Q: Tôi có phải mang thiết bị của riêng mình (shinai, bogu) đến đội tập không ?",
        answer:
          "A: Chúng ta có shinai dự phòng cho mọi người không có. Đối với những người có thể tập luyện trong bogu, bạn nên mang bogu của riêng mình vì chúng ta không có đủ bogu dự phòng và không có chỗ để lưu trữ bogu.",
      },
      {
        question: "Q: Chúng ta có yêu cầu gì để tham gia câu lạc bộ không ?",
        answer:
          "A: Để tham gia câu lạc bộ của chúng ta, bạn phải là sinh viên hoặc cựu sinh viên của RMIT để truy cập vào đội tập của chúng ta. Ngoài ra, chúng tôi chào đón những người mới bắt đầu chưa từng tập luyện Kendo và muốn thử sức, chúng tôi cũng chào đón bất kỳ ai đã từng tập luyện Kendo trước đó tham gia cùng chúng tôi.",
      },
    ],
    ...
    footer: [
      ...
      {
        ownership:
          "Sản phẩm này hoàn toàn thuộc sở hữu của Câu Lạc Bộ Kendo RMIT Shinsei.",
      },
      {
        author: "Tác Giả",
        description: "Nhóm Kỹ Thuật RMIT club Kendo Shinsei",
      },
      {
        leader: "Trưởng Dự Án",
        leaderName: "Phạm Hoàng Dương (Alex)",
      },
      {
        devs: "Nhà Phát Triển",
        dev1: "Nguyễn An",
    ...
    AgendaData: [
      {
        date: "30 Tháng 5",
        events: [
          { time: "6:30 Tối", activity: "Bắt đầu hội thảo" },
          { time: "8:30 Tối", activity: "Kết thúc hội thảo" },
        ],
      },
      {
        date: "31 Tháng 5",
        events: [
          { time: "8:00 Sáng", activity: "Check-in" },
          { time: "9:30 Sáng", activity: "Lễ Khai Mạc" },
          { time: "10:00 Sáng", activity: "Trận Đấu Buổi Sáng" },
          { time: "12:00 Trưa", activity: "Giờ Nghỉ Trưa" },
          { time: "1:00 Chiều", activity: "Trận Đấu Buổi Chiều" },
          { time: "4:30 Chiều", activity: "Kết thúc ngày 1" },
        ],
      },
      {
        date: "1 Tháng 6",
        events: [
          { time: "8:15 Sáng", activity: "Lễ Khai Mạc" },
    ...
    riktData: {
      heroSection: {
        button: "ĐIỀU LỆ GIẢI ĐẤU",
      },
      agendaTitle: "Lịch Trình",
      agendaDescription: "Cuộn xuống để xem lịch trình",
